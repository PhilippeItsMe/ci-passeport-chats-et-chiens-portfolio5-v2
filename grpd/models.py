...
class CookieConsent(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True) #If logged
    session_key = models.CharField(max_length=255, null=True, blank=True) #If not logged
